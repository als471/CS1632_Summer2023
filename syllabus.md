...
# CS 1632
Software Quality Assurance - Summer 2023
...
**Class Time and Location:**
  ...
  * Tue/Thu 11:30 PM - 1:15 PM @ 5502 Sennott Square

**Instructor's Office Hours:**

  * Chat on Microsoft Teams: Mon-Fri 9:00 AM - 6:00 PM
  * Physical Office Hours: @ 5423 Sennott Square, by appointment

**Class GitHub repo:** https://www.github.com/wonsunahn/CS1632_Summer2023
...
Exercises will be released each day in class.  You will be given time
in-class to complete it and if you don't, you have until the start of next
class to submit it.  If you had any difficulties, you will have a chance to
ask questions at the beginning of the next class.
...
late, you would receive 90 - 15 = 75%.).  Due to the grading deadline, there
is no late submission for Deliverable 5 and only one week late submission is
allowed for Deliverable 4.

## Programming Language Selection

For all deliverables, the class will use Java with the appropriate
frameworks (JUnit, Mockito, Selenium).  Projects written in other languages
or using alternative frameworks will not be accepted.
...
The university policy is to be back to full in-person.  That means we are
back to pre-COVID rules concerning remote classes: it does not exist, as a
general rule.  The only exception is when you have a family or medical
emergency that would cause you to miss class.  Rather than miss class, if
you are able to participate over Zoom, please let me know at least one day
ahead of time and I will try to set it up.  These Zoom sessions are only
available to affected students and are protected by a password which is
